...
<body>
		...
		<div class="container">
			<div class="col-md-6 inner-banner">
				<h4 class="title-about about text-center">leave it to us
					<span>for any kind </span> of help
					<span>needs
					</span>
				</h4>
			</div>
	...
	<div class="section  stats">
		<div class="container">
			<h5>On time,On budget, with in Scope and with Quality Services.</h5>
			<div class="stats-aboutinfo services-main">
				<div class="col-sm-3 col-xs-3 stats-grid text-center">
				...
				<div class="col-sm-3 col-xs-3 stats-grid text-center">
					...
					<div class="stats-right">
						<h6>Customer Staisfaction</h6>
						<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='92' data-delay='.5' data-increment="1">92</div>
				...
				<div class="col-sm-3 col-xs-3 stats-grid text-center">
					...
					<div class="stats-right">
						<h6>projects</h6>
						<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='69' data-delay='.5' data-increment="1">69</div>
	...
	<div class="about-slid">
		<div class="container">
			<h6 class="slid">Trusted and Reliable Helpers and Service Providers</h6>
		</div>
	</div>
	<!-- //about-slid -->
	<br><br>
