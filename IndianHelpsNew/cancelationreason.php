...
<head>
	<title>IndianHelps | Cancellation Reason</title>
	<!-- for-mobile-apps -->
		...
		<div class="container">
			<div class="register-top">
				...
				<div class="col-md-7 col-sm-7 register-right">
					<form action="updatecancel.php" method="POST" class="banner_form">
						<h6>Give us the reason for Cancellation</h6>
						<div class="sec-right">
							<label class="contact-form-text"></label>
							<select name="reason">
								<option>Helper was not on time</option>
								<option>Service Placed By Mistake</option>
								<option>Some Other Problem Occured</option>
							</select>
							</div>
							<input type = "hidden" value='<?php echo $service;?>' name='hf'/>
