...
<head>
	<title>IndianHelps | Forgot Password</title>
	<!-- for-mobile-apps -->
		...
		<div class="container">
			<div class="register-top">
				...
				<div class="col-md-7 col-sm-7 register-right">
					<form action="recoverpassword.php" method="POST" class="banner_form">
						...
						<div class="sec-left">
							...
							<input placeholder="Your Phone No" name="phone" type="password" required="">
						</div>
						<div>
