	...
	<div class="section plans">
		<div class="container">
			...
			<div class="services-main">
				...
				include "dbcon.php";
				$query = "select * from task_create where rid !='$validate' and stats = 'Active' and city='$city' ORDER BY tid DESC";
				$result = mysqli_query($con,$query) or die(mysqli_error($con));
				}
				else
				{
				include "dbcon.php";
				$query = "select * from task_create where stats = 'Active' and city='$city' ORDER BY tid DESC";
				$result = mysqli_query($con,$query) or die(mysqli_error($con));				
				}
