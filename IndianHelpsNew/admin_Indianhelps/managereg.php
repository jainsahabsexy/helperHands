      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          <div class="table-responsive">
            ...
            <?php
              include "dbcon.php";              
              $query = "select * from register where approval = 'Pending'";
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="../userimage/<?php echo $row['fr_aadh_photo'];?>" target="_blank"><img src="../userimage/<?php echo $row['fr_aadh_photo'];?>" height="100px" width="100px"/></a></td>
                  ...
                  <td><?php echo $row["intr_of_work"];?></td>
                  <td><?php echo $row["approval"];?></td>
                  <td>
                    <form action="getApprove.php" method="POST">
                    <select name="txtapp">
                      <option>Select the approval...</option>
                      <option>Approved</option>
                      <option>Not Approved</option>                      
                    </select>
                    <br><br>
                    
                    <input type="text" name="comm" placeholder="Comment" class="form-control">
                  </td>                  
                <input type="hidden" name="hf" value="<?php echo $row['rid'];?>"/>
